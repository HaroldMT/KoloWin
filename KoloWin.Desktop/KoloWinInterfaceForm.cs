...
namespace KoloWin.Desktop
{
    public partial class KoloWinInterfaceForm : Form
    {
        ...
        private void tileNavPane1_Click_1(object sender, EventArgs e)
        {

        }

        private void KoloWinInterfaceForm_Load(object sender, EventArgs e)
        {
                    }

        private void tileNavPane1_Click_2(object sender, EventArgs e)
        {
